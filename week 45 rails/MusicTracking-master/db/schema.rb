...
ActiveRecord::Schema.define(version: 20150515003651) do
  ...
  create_table "albums", force: :cascade do |t|
    ...
    t.string   "album_recording_type", null: false
  end
  ...
  create_table "tracks", force: :cascade do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.string   "track_bonus", null: false
    t.text     "lyrics"
  end
